...
// QuickTest.h : main header file for the PROJECT_NAME application
//
...
// CQuickTestApp:
// See QuickTest.cpp for the implementation of this class
//

class CQuickTestApp : public CWinApp
{
public:
	CQuickTestApp();
