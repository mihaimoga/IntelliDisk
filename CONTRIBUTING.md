...
***Ask not what IntelliDisk can do for you - ask what you can do for IntelliDisk***
...
2. Include additional information such as:
    ...
    * IntelliDisk Debug-Info containing:
...
1. Respect existing IntelliDisk coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
