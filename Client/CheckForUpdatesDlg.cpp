...
#if _WIN64
#ifdef _DEBUG
#pragma comment(lib, "../Setup/x64/Debug/genUp4win.lib")     // 64-bit Debug build
#else
#pragma comment(lib, "../Setup/x64/Release/genUp4win.lib")   // 64-bit Release build
#endif
#else
#ifdef _DEBUG
#pragma comment(lib, "../Setup/Debug/genUp4win.lib")         // 32-bit Debug build
#else
#pragma comment(lib, "../Setup/Release/genUp4win.lib")       // 32-bit Release build
#endif
#endif
